...
{
    public class ReceiptReaderRequestEdit_ReceiptReaderRequestMsg_Profile : Profile
    {
        public ReceiptReaderRequestEdit_ReceiptReaderRequestMsg_Profile()
        {
            CreateMap<ReceiptReaderRequestEdit, AiReceiptReaderRequestMsg>()
